# EL DISEÑO FRACTURADO

### *El diagnóstico relacional de una civilización sola y la respuesta de la comunidad de pacto*

Como consecuencia del desarrollo tecnológico, vivimos en el momento de mayor conectividad de la historia humana y, simultáneamente, en el más solo. Una de cada cuatro personas mayores de quince años en el planeta —más de mil millones de almas— declara sentirse sola con frecuencia. Sin embargo, esta crisis no es un defecto de carácter individual ni el resultado del egoísmo de una generación: es una **fractura sistémica de la arquitectura relacional** (*Génesis 2:18, RVR1960*). El ser humano no fue diseñado para la hiperconectividad digital ni para la autosuficiencia, sino para la alteridad encarnada.
